    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Welcome to your employee scheduling dashboard</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Set up your first employee and create your first schedule
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your latest scheduling activities
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm">Start by adding employees and creating schedules</p>
              </div>
            </CardContent>
          </Card>
        </div>
